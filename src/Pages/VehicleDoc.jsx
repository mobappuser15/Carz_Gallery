...
function VehicleDoc({ product, uniquekey }) {
	...
	function handeldelete(ind1, ind2) {
		dataimage
			?.filter((item, index) => item.SubModuleCode === "VEH_DOC")
			.map((item, index) => {
	...
	const SaveDataApi = (item, index) => {
		...
		formData.append("CompanyId", "CARZ");
		formData.append("BrandCode", "UC");
		formData.append("CountryCode", "IN");
		formData.append("LogUserId", "Manish");
					...
					{dataimage
						...
						.map((item, index) => (
							<>
									...
									{!input1 &&
										item.DocGroups[0].DocCodes[0].AzureUri === null && (
											<input
												...
												style={{}}
												onChange={(e) => {
													handleFileChange(index, e, 0, 0, "RC");
													reload();
													setInput1(true);
												}}
											/>
									...
									{!input2 &&
										item.DocGroups[1].DocCodes[0].AzureUri === null && (
											<input
												...
												style={{}}
												onChange={(e) => {
													handleFileChange(index, e, 1, 0, "INSURANCE");
													reload();
													setInput2(true);
												}}
											/>
									...
									{!input3 &&
										item.DocGroups[2].DocCodes[0].AzureUri === null && (
											<input
												...
												style={{}}
												onChange={(e) => {
													handleFileChange(index, e, 2, 0, "PUC");
													reload();
													setInput3(true);
												}}
											/>
									...
									{!input4 &&
										item.DocGroups[3].DocCodes[0].AzureUri === null && (
											<input
												...
												style={{}}
												onChange={(e) => {
													handleFileChange(index, e, 3, 0, "NOC");
													reload();
													setInput4(true);
												}}
											/>
								...
								<div className='col-2 cl_wd1' key={item.DisplaySerial}>
									<h5 onClick={SaveDataApi(item, index)}>
										{item.DocGroups[4].DocCodes[0].DocDescription}
									</h5>
									{!input5 &&
										item.DocGroups[3].DocCodes[0].AzureUri === null && (
											<input
												...
												style={{}}
												onChange={(e) => {
													handleFileChange(index, e, 4, 0, "HYPOTHE");
													reload();
													setInput5(true);
												}}
											/>
									...
									{selectedFiles[(4, 0)] ? (
										...
										<>
											{item.DocGroups[4].DocCodes[0].AzureUri !== null ? (
												<>
													{" "}
													<img
														className='imageuploads'
														src={item.DocGroups[4].DocCodes[0].AzureUri}
														alt='AzureUri'
														onClick={() => handleImageClick(index)}
													/>
													<DeleteIcon
												...
												<>
													<img
														className='imageuploads data23'
														src={item.DocGroups[4].DocCodes[0].DocTypeIconPath}
														alt='AzureUri'
														onClick={() => handleImageClick(index)}
													/>
												</>
