...
function ContactDoc({ product, uniquekey, company, username }) {
				...
				<div className='row'>
					{dataimage
						...
						.map((item, index) => (
							<>
								<div
									className='col-2 position-relation cl_wd1'
									...
									{!input1 &&
										item.DocGroups[0].DocCodes[0].AzureUri === null && (
											<input
												...
												style={{}}
												onChange={(e) => {
													handleFileChange(index, e, 0, 0, "SALE_FORM");
													setInput1(true);
												}}
											/>
										)}
									...
									{!input2 &&
										item.DocGroups[1].DocCodes[0].AzureUri === null && (
											<input
												...
												style={{}}
												onChange={(e) => {
													handleFileChange(index, e, 1, 0, "UDR_FORM");
													reload();
													setInput2(true);
												}}
											/>
