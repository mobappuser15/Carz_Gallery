...
const DeleveryForm = ({ uniquekey }) => {
	...
	console.log("i am unique serial delevry ", uniqueSerial);
	...
	console.log(uniquekey, remark, "data delevery form");
	return (
		<div>
			...
			<form
				...
				<div className='row'>
					...
					<div className='col-md-3 col-sm-6 col-xs-12'>
						<label className='labeldelevry'>Gross Selling Price</label>
						<input
							type='number'
							className='admintextbox'
							required=''
