...
const EditForm = () => {
	...
	console.log(PropsData, "PropsData tada jdjdjjfh");
	...
	const handleCarBrandChange = (event) => {
		console.log("handleSelectChange23 jdfjdjf", carBrand, carModal);
		if (event != null) {
			console.log("handleSelectChange22", event, event.target.value);
			setCarBrand(event.target.value);
			setCarBrand(event.target.value);
		} else {
			console.log("handleSelectChange23", carBrand, carModal);
	...
	const handleCarModalChange = (event) => {
		if (event != null) {
			...
			console.log("handleCarModalChange", carModal);
		}
	};
